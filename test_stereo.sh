...
point2dem --t_srs EPSG:32645 --tr 2 dem-PC.tif --dem-hole-fill-len 200 --erode-length 0 --nodata-value 0 --tif-compress "Deflate" --max-valid-triangulation-error 4.
gdalwarp -wm 512 -q -co COMPRESS=DEFLATE -overwrite -of GTiff -ot Float32 -r cubic dem-DEM.tif ../test-dsm.tiff
