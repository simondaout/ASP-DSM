...
IMG1="$HOME/INPUT/orthoimage_nadir_$DATE1.tif"
IMG2="$HOME/INPUT/orthoimage_nadir_$DATE2.tif"
IMG1_CROP="$HOME/INPUT/orthoimage_nadir_crop_$DATE1.tif"
IMG2_CROP="$HOME/INPUT/orthoimage_nadir_crop_$DATE2.tif"
...
gdal_translate -q -b 1 -co COMPRESS=LZW $OUTPUT_DIR-F.tif EW_2014_filter.tif
gdal_translate -q -b 2 -co COMPRESS=LZW $OUTPUT_DIR-F.tif NS_2014_filter.tif
gdal_translate -q -b 3 -co COMPRESS=LZW $OUTPUT_DIR-F.tif CC_2014_filter.tif

DATE1="202301150511233"
DATE2="202312190511471"
