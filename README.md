...
* The majority of the scripts are written in bash and python and do not need installation. Just add them to your PATH. If you are using module, an example of modulefile is available in /contrib/modulefile/asp-dsm
...
2) Generate a parameter file and fill parameters of interest and project-related parameters (`dsm_pleiades_new.py --preset=default`)
3) Launch the command with the parameter file path indicated (`dsm_pleiades.py --toml=asp_dsm_params.toml`)
